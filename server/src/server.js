...
app.use(
  cors({
    origin: [
      "http://localhost:5173",
      "https://master--creative-dieffenbachia-412ccf.netlify.app",
    ],
    credentials: true,
  })
);
...
app.use("/api/v3/image", express.static(path.join(__dirname, "/public")));
...
app.use("/api/v3", require("./routes/mongodb/contacto.js"));
//
// app.use("*", (req, res) => {
