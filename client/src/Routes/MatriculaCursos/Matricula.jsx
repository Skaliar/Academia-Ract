...
export default function Curso({ matricula, edit, riviewList }) {
  ...
  const initialForm = {
    ...
    student: matricula ? matricula.student : "",
    turno: matricula ? matricula.turno : "",
    finicio: matricula ? parseISO(matricula.finicio) : new Date(),
    ffin: matricula ? parseISO(matricula.ffin) : new Date(),
  };

  let { formData, onInputChange, validateForm, errorsInput, clearForm, setFormState } = useForm(initialForm, validationSchema);
                ...
                <aside>
                  ...
                  <div className="row mt-3">
                    <div className="form-group col-md-6">
                      ...
                      <DatePicker
                        selected={finicio}
                        onChange={(date) => handleDateChange(date, "finicio")}
                        className="form-control"
                        name="finicio"
                    ...
                    <div className="form-group col-md-6">
                      ...
                      <DatePicker
                        selected={ffin}
                        onChange={(date) => handleDateChange(date, "ffin")}
                        className="form-control"
                        name="ffin"
                        dateFormat="yyyy-MM-dd"
                      />
